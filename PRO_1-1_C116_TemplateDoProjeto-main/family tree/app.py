...
def pai():
    ...
    nome = "pai do Jorge" # escreva seu nome
    idade = "35" # escreva sua idade
...
def mae():
    ...
    nome = "mae do Jorge" # escreva seu nome
...
def amigo():
    ...
    nome = "amigo do Jorge" # escreva seu nome
    idade = "4" # escreva sua idade
